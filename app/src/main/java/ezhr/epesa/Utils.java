...
public class Utils {
        ...
        Dexter.withActivity(activity)
                ...
                .withListener(new MultiplePermissionsListener() {
                    ...
                    public void onPermissionsChecked(MultiplePermissionsReport report) {
                        if (report.isAnyPermissionPermanentlyDenied()) {
                            new MaterialDialog.Builder(activity)
                                    ...
                                    .content("Unfortunately, owode cannot function without the required permissions. Please grant them in" +
                                            " Settings.")
                    ...
                    public void onPermissionRationaleShouldBeShown(List<PermissionRequest> permissions, final PermissionToken token) {
                        new MaterialDialog.Builder(activity)
                                .title("Whoops!")
                                .content("Looks like some permissions are missing in order for owode to work correctly. Please grant " +
    ...
    private static void setupNotificationChannels(NotificationManager manager) {
        ...
        CharSequence completedChannelName = "owode Completed Transactions";
        int completedChannelImportance = NotificationManagerCompat.IMPORTANCE_DEFAULT;

        CharSequence ongoingChannelName = "owode Ongoing Transactions";
